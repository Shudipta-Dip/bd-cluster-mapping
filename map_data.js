...
const mapData = {
  ...
  ports: [
    ...
    { name: "Banglabandha Land Port", type: "Land Port", lat: 26.6341, lng: 88.4026, desc: "NW gateway. ~1.7M MT/yr. Nepal trade route.", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/4/42/Banglabandha_Port.jpg" },
    ...
    { name: "Bibirbazar Land Port", type: "Land Port", lat: 23.3200, lng: 91.3800, desc: "~90K MT exports. Rebounding.", imageUrl: "https://risingcumilla.com/wp-content/uploads/2023/06/Comilla-Bibir-Bazar-Land-Port-Increased-traffic-of-people-from-both-countries.webp" },
  ...
  belts: [
    {
      ...
      color: "#ef4444",
      coordinates: [
        [26.6341, 88.4026], [26.3315, 89.0494], [25.8800, 89.3900], [25.7500, 88.9000],
